...
static void get_round_keys(const uint64_t *key, uint32_t *round_keys) {
...
void addRoundKey(uint8_t state[4][4], uint32_t roundKey[4], uint8_t newState[4][4]) {
    for (int c = 0; c < 4; c++) {
...
void subBytes(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
...
void shiftRows(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
...
void mixColumns(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int j = 0; j < 4; j++) {
...
int aes128_encrypt(const uint64_t *plaintext, const uint64_t *key, uint64_t *ciphertext) {
...
void invSubBytes(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
...
void invShiftRows(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
...
void invMixColumns(uint8_t state[4][4], uint8_t newState[4][4]) {
    for (int j = 0; j < 4; j++) {
...
int aes128_decrypt(const uint64_t *ciphertext, const uint64_t *key, uint64_t *plaintext) {
    // state
